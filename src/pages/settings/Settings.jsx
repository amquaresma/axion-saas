...
export function Settings() {
  ...
  useEffect(() => {
    if (user) setForm({ name: user.user_metadata?.name || '', email: user.email || '' })
  }, [user])
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 mb-6">
          <h2 className="text-base font-semibold text-gray-900 dark:text-white mb-4">Informações do perfil</h2>
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 mb-6">
          <h2 className="text-base font-semibold text-gray-900 dark:text-white mb-4">Alterar senha</h2>
          <div className="flex flex-col gap-4">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
          <h2 className="text-base font-semibold text-gray-900 dark:text-white mb-1">Conta</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Encerrar sessão no Axion.</p>
